...
/**
 * 
 * The  program GodDrinksJava imprements an application that
...
public class GodDrinksJava {
    public static void main(String[] args) {
        ...
        if(me instanceof SineWave){
            you.addAction("sit", me.getTangent(you.getXposiiton()));
        }
